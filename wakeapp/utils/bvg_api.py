...
class bvg_api:
    ...
    def fetch_location_id(self, location: str, poi:bool = False) -> int:
    ...
    def fetch_depature_arrival_time(self, origin: int, destination:int, arrival_time: datetime) -> Tuple[str, str]:
